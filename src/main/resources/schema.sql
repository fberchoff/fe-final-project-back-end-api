...
CREATE TABLE `token` (
  ...
  CONSTRAINT `fk_user_token` FOREIGN KEY (`user_id`) REFERENCES `user1` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project` (
  ...
  CONSTRAINT `fk_project_User` FOREIGN KEY (`user_id`) REFERENCES `user1` (`user_id`) ON DELETE CASCADE
